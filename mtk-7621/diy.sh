...
sed -i 's/vpn/services/g' luci/applications/luci-app-zerotier/luasrc/controller/zerotier.lua
sed -i 's/VPN/Services/g' luci/applications/luci-app-zerotier/luasrc/controller/zerotier.lua
sed -i 's/vpn/services/g' luci/applications/luci-app-zerotier/luasrc/view/zerotier/zerotier_status.htm
sed -i "/exit 0/i\sed -i 's/vpn/services/g'" luci/applications/luci-app-zerotier/luasrc/controller/zerotier.lua
sed -i "/exit 0/i\sed -i 's/VPN/Services/g'" luci/applications/luci-app-zerotier/luasrc/controller/zerotier.lua
sed -i "/exit 0/i\sed -i 's/vpn/services/g'" luci/applications/luci-app-zerotier/luasrc/view/zerotier/zerotier_status.htm
